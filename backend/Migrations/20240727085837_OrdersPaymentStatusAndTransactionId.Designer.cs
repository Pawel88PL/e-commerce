...
namespace MiodOdStaniula.Migrations
{
    ...
    [Migration("20240727085837_OrdersPaymentStatusAndTransactionId")]
    partial class OrdersPaymentStatusAndTransactionId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.ShopingCart", b =>
                {
                    b.Property<Guid>("ShopingCartId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("backend.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("backend.Models.ShopingCart", "ShopingCart")
                        .WithMany("CartItems")
